...
public class MergeBrevTemplate extends AbstractWebScript {
    ...
    public void execute(WebScriptRequest webScriptRequest, WebScriptResponse webScriptResponse) throws IOException {
        ...
        System.out.println("generateBrevDocument");

        NodeRef newDocument = documentTemplateBean.generateBrevDocument(new NodeRef("workspace://SpacesStore/" + (String)json.get("id")));
